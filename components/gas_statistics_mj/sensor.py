...
# of the reset month (e.g. 31 falls back to the 28th/29th in February). Bind
# the same number entity used by gas_statistics so both m3 and MJ reset
# together.
...
# anchor+6, anchor+9 (e.g. anchor=2 => Feb/May/Aug/Nov). Bind the same
# number entity used by gas_statistics so both m3 and MJ share one anchor.
